...
public struct ListBackupVaultsResponse: Codable, Equatable, GoogleCloudWKT._AnyPackable,
  GoogleCloudGax._PaginatedResponse,
  Sendable
{
  /// A list of backupVaults in the project for the specified location.
  public var backupVaults: [BackupVault] = []
  ...
  /// Initialize a new instance of `ListBackupVaultsResponse`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListBackupVaultsResponse().with { $0.backupVaults = ... }
  /// ```
  ...
  private struct CodingKeys: CodingKey {
    ...
    static let backupVaults = CodingKeys(stringValue: "backupVaults")
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.netapp.v1.ListBackupVaultsResponse"
  }
