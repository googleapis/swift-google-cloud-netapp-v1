...
public struct ListStoragePoolsResponse: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  /// The list of StoragePools
  public var storagePools: [StoragePool] = []
  ...
  /// Initialize a new instance of `ListStoragePoolsResponse`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListStoragePoolsResponse().with { $0.storagePools = ... }
  /// ```
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent([StoragePool].self, forKey: .storagePools) {
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.netapp.v1.ListStoragePoolsResponse"
  }
...
extension ListStoragePoolsResponse: GoogleGax._PaginatedResponse {
