...
public struct TieringPolicy: Codable, Equatable, GoogleCloudWKT._AnyPackable,
  Sendable
{
  /// Optional. Flag indicating if the volume has tiering policy enable/pause.
  /// Default is PAUSED.
  public var tierAction: TieringPolicy.TierAction? = nil
  ...
  public var coolingThresholdDays: Swift.Int32? = nil
  ...
  ///
  /// ```
  /// let value = TieringPolicy().with { $0.tierAction = ... }
  /// ```
  ...
  public enum TierAction: Codable, Equatable, Sendable {
    /// Unspecified.
    case unspecified
    ...
    public var stringValue: Swift.String? {
      switch self {
      case .unspecified: return "TIER_ACTION_UNSPECIFIED"
    ...
    ///
    /// If the value is unknown, this initializes to [`unknownStringValue`](doc:TierAction/unknownStringValue(_:)).
    public init(stringValue: Swift.String) {
      switch stringValue {
      case "TIER_ACTION_UNSPECIFIED": self = .unspecified
    ...
    ///
    /// If the value is unknown, this initializes to [`unknownIntValue`](doc:TierAction/unknownIntValue(_:)).
    ...
    public func encode(to encoder: Encoder) throws {
      ...
      switch self {
      case .unspecified: return try container.encode("TIER_ACTION_UNSPECIFIED")
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.netapp.v1.TieringPolicy"
  }
