  ...
  Sendable
{
  ...
  public var replications: [Replication] = []
  ...
  /// Initialize a new instance of `ListReplicationsResponse`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListReplicationsResponse().with { $0.replications = ... }
  /// ```
  ...
  private struct CodingKeys: CodingKey {
    ...
    static let replications = CodingKeys(stringValue: "replications")
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent([Replication].self, forKey: .replications) {
      self.replications = value
    }
  ...
  public func encode(to encoder: Encoder) throws {
    ...
    try container.encode(self.replications, forKey: .replications)
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.netapp.v1.ListReplicationsResponse"
  }
