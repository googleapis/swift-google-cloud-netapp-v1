...
public struct ExecuteOntapDeleteRequest: Codable, Equatable, GoogleCloudWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `ExecuteOntapDeleteRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ExecuteOntapDeleteRequest().with { $0.ontapPath = ... }
  /// ```
  ...
  private struct CodingKeys: CodingKey {
    ...
    static let ontapPath = CodingKeys(stringValue: "ontapPath")
  ...
  public func encode(to encoder: Encoder) throws {
    ...
    try container.encode(self.ontapPath, forKey: .ontapPath)
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.netapp.v1.ExecuteOntapDeleteRequest"
  }
