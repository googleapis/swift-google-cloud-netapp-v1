...
public struct StopReplicationRequest: Codable, Equatable, GoogleCloudWkt._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `StopReplicationRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = StopReplicationRequest().with { $0.name = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.netapp.v1.StopReplicationRequest"
  }
