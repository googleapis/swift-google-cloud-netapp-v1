...
public struct ListReplicationsRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `ListReplicationsRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListReplicationsRequest().with { $0.parent = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.netapp.v1.ListReplicationsRequest"
  }
