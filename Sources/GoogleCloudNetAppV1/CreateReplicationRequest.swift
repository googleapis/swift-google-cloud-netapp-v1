...
public struct CreateReplicationRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  ///
  /// ```
  /// let value = CreateReplicationRequest().with { $0.parent = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.netapp.v1.CreateReplicationRequest"
  }
