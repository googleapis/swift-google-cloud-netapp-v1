...
public enum ScaleType: Codable, Equatable, Sendable {
  ...
  public var stringValue: Swift.String? {
    ...
    case .`default`: return "SCALE_TYPE_DEFAULT"
    case .scaleout: return "SCALE_TYPE_SCALEOUT"
  ...
  public init(stringValue: Swift.String) {
    ...
    case "SCALE_TYPE_DEFAULT": self = .`default`
    case "SCALE_TYPE_SCALEOUT": self = .scaleout
  ...
  public func encode(to encoder: Encoder) throws {
    ...
    case .`default`: return try container.encode("SCALE_TYPE_DEFAULT")
    case .scaleout: return try container.encode("SCALE_TYPE_SCALEOUT")
