  ...
  Sendable
{
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent(KmsConfig.State.self, forKey: .state) {
      self.state = value
    }
  ...
  public enum State: Codable, Equatable, Sendable {
    ...
    public func encode(to encoder: Encoder) throws {
      ...
      case .keyCheckPending: return try container.encode("KEY_CHECK_PENDING")
      case .keyNotReachable: return try container.encode("KEY_NOT_REACHABLE")
