...
public struct HybridReplicationParameters: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  public enum VolumeHybridReplicationType: Codable, Equatable, Sendable {
    ...
    public func encode(to encoder: Encoder) throws {
      ...
      switch self {
      case .unspecified: return try container.encode("VOLUME_HYBRID_REPLICATION_TYPE_UNSPECIFIED")
