...
public struct ExecuteOntapPostRequest: Codable, Equatable, GoogleCloudWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `ExecuteOntapPostRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ExecuteOntapPostRequest().with { $0.body = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.netapp.v1.ExecuteOntapPostRequest"
  }
