...
public struct ListHostGroupsResponse: Codable, Equatable, GoogleCloudWKT._AnyPackable,
  ...
  Sendable
{
  ...
  /// Initialize a new instance of `ListHostGroupsResponse`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListHostGroupsResponse().with { $0.hostGroups = ... }
  /// ```
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent([HostGroup].self, forKey: .hostGroups) {
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.netapp.v1.ListHostGroupsResponse"
  }
