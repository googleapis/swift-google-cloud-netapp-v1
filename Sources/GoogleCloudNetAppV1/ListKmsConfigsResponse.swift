...
public struct ListKmsConfigsResponse: Codable, Equatable, GoogleCloudWKT._AnyPackable,
  GoogleCloudGax._PaginatedResponse,
  Sendable
{
  /// The list of KmsConfigs
  public var kmsConfigs: [KmsConfig] = []
  ...
  /// Initialize a new instance of `ListKmsConfigsResponse`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListKmsConfigsResponse().with { $0.kmsConfigs = ... }
  /// ```
  ...
  private struct CodingKeys: CodingKey {
    ...
    static let kmsConfigs = CodingKeys(stringValue: "kmsConfigs")
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent([KmsConfig].self, forKey: .kmsConfigs) {
      self.kmsConfigs = value
    }
  ...
  public func encode(to encoder: Encoder) throws {
    ...
    try container.encode(self.kmsConfigs, forKey: .kmsConfigs)
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.netapp.v1.ListKmsConfigsResponse"
  }
