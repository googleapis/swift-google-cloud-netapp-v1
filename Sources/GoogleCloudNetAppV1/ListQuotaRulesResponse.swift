...
public struct ListQuotaRulesResponse: Codable, Equatable, GoogleCloudWKT._AnyPackable,
  GoogleCloudGax._PaginatedResponse,
  Sendable
{
  /// List of quota rules
  public var quotaRules: [QuotaRule] = []
  ...
  /// Initialize a new instance of `ListQuotaRulesResponse`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListQuotaRulesResponse().with { $0.quotaRules = ... }
  /// ```
  ...
  private struct CodingKeys: CodingKey {
    ...
    static let quotaRules = CodingKeys(stringValue: "quotaRules")
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent([QuotaRule].self, forKey: .quotaRules) {
      self.quotaRules = value
    }
  ...
  public func encode(to encoder: Encoder) throws {
    ...
    try container.encode(self.quotaRules, forKey: .quotaRules)
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.netapp.v1.ListQuotaRulesResponse"
  }
