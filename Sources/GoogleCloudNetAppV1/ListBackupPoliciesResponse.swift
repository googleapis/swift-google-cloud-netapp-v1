...
public struct ListBackupPoliciesResponse: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  /// The list of backup policies.
  public var backupPolicies: [BackupPolicy] = []
  ...
  /// Initialize a new instance of `ListBackupPoliciesResponse`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListBackupPoliciesResponse().with { $0.backupPolicies = ... }
  /// ```
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent([BackupPolicy].self, forKey: .backupPolicies) {
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.netapp.v1.ListBackupPoliciesResponse"
  }
...
extension ListBackupPoliciesResponse: GoogleGax._PaginatedResponse {
  public func _getPaginatedItems() -> [BackupPolicy] {
    return self.backupPolicies
  }
