...
public struct ExecuteOntapGetRequest: Codable, Equatable, GoogleCloudWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `ExecuteOntapGetRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ExecuteOntapGetRequest().with { $0.ontapPath = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.netapp.v1.ExecuteOntapGetRequest"
  }
